    ...
    >
      <div className="legal-toc">
        ...
        <ol>
          ...
          <li><a href="#allergens">Allergens &amp; food safety</a></li>
      ...
      <h2 id="about">1. About <em>us</em></h2>
      <p>These terms govern your use of <code>{siteConfig.domain}</code> and your orders placed through it. By using the site or placing an order, you agree to be bound by these terms. If you don't agree, please don't use the site.</p>
      <p>We are {siteConfig.name}, a home-kitchen meal delivery service operating from Middlesbrough, North Yorkshire, United Kingdom. Contact details are at the bottom of this page.</p>

      <h2 id="account">2. Your <em>account</em></h2>
      ...
      <h2 id="prices">4. Prices &amp; <em>payment</em></h2>
      <p>All prices are in pounds sterling (£) and include VAT where applicable. Delivery fees are shown at checkout before you pay.</p>
      <p>We accept payment by:</p>
      <ul>
        <li><b>Card</b> — handled securely by Stripe. We never see or store your card details.</li>
        <li><b>Cash on Delivery</b> — where the item allows it and the delivery zone permits it. Payable in pounds sterling cash to the driver. Please have correct change where possible.</li>
      </ul>
      ...
      <h2 id="cancellation">6. Cancellation &amp; <em>refunds</em></h2>
      <p>Under the Consumer Contracts Regulations 2013, perishable goods (which includes prepared hot food) are <b>exempt from the 14-day right of withdrawal</b>. However, we operate the following voluntary cancellation policy:</p>
      <ul>
        <li><b>Before the kitchen starts cooking</b> (status: Received): cancel from your order tracking page — instant full refund</li>
        <li><b>After cooking has started</b> (status: Preparing or later): contact us via WhatsApp — we'll do our best but a refund may not be possible if ingredients are committed</li>
      </ul>
      <p>If something is wrong with your order (missing item, food not as described, allergen concern), contact us within 24 hours of delivery and we'll make it right.</p>
      <p>Full details in our <a href={siteConfig.routes.legal.refund}>Refund Policy</a>.</p>

      <h2 id="allergens">7. Allergens &amp; food <em>safety</em></h2>
      <p>We hold a <b>5-star Food Hygiene Rating</b> from the UK Food Standards Agency. Each menu item lists known allergens (gluten, dairy, nuts, seafood, etc.) — please check before ordering.</p>
      <p>Our kitchen is not allergen-free. We handle wheat, dairy, eggs, fish, shellfish, peanuts and other tree nuts on shared equipment. Trace cross-contact is possible. If you have a serious allergy, please contact us before ordering so we can advise.</p>
      <p>You're responsible for verifying that listed allergen information meets your needs. We are not liable for allergic reactions caused by ingredients clearly listed in the item description.</p>

      <h2 id="liability">8. <em>Liability</em></h2>
      <p>Nothing in these terms limits or excludes our liability for:</p>
      <ul>
        <li>Death or personal injury caused by our negligence</li>
        <li>Fraud or fraudulent misrepresentation</li>
        <li>Any breach of your statutory rights as a consumer under the Consumer Rights Act 2015 (including the right to goods of satisfactory quality, fit for purpose, and as described)</li>
        <li>Any other liability that cannot be lawfully excluded</li>
      </ul>
      <p>Subject to that, our total liability to you in connection with any order is limited to the amount you paid for that order.</p>

      <h2 id="ip">9. Intellectual <em>property</em></h2>
      <p>The site content (photography, copy, branding, layout) is owned by {siteConfig.name} or licensed to us. You may not copy, reproduce, or use it commercially without our written permission. Personal, non-commercial use is fine.</p>

      <h2 id="law">10. Governing <em>law</em></h2>
      <p>These terms are governed by the laws of England and Wales. Any disputes will be resolved in the courts of England and Wales, subject to your statutory consumer rights.</p>

      <h2 id="changes">11. <em>Changes</em></h2>
      <p>We may update these terms from time to time. The current version is always at this URL with the "Last updated" date at the top. Material changes will be communicated by email to account holders at least 14 days before they take effect. Orders placed under previous terms are governed by the terms in force at the time of the order.</p>
