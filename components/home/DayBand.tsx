...
export default function DayBand({
  ...
  return (
    <div className="border-y border-[rgba(241,229,205,0.22)] bg-[--color-walnut] text-[--color-cream]">
      <div className="container flex flex-wrap items-center justify-between gap-6 py-[18px]">
        <span className="font-serif text-[15px] italic text-[#F1E5CDEB]">
          <b className="mr-2 font-medium text-[--color-bronze] not-italic tracking-[0.14em] [font-variant:small-caps]">
            {daysShort}
          </b>
          {hoursShort} · {cutoff}
        </span>
        <Link
          href={cta.href}
          className="rounded-[2px] bg-[--color-bronze] px-5 py-[10px] font-serif text-[13px] font-semibold uppercase tracking-[0.16em] text-[--color-walnut] [font-variant:small-caps] transition-colors hover:bg-[--color-cream] hover:text-[--color-walnut]"
        >
          {cta.label}
        </Link>
      </div>
