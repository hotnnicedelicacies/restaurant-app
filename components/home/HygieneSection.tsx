...
export default function HygieneSection() {
  ...
  return (
    <section className="relative border-y border-rule bg-cream-soft py-[clamp(56px,8vw,96px)]">
      <span
      ...
      <div className="container mx-auto max-w-[560px] text-center">
        <div
          className="mb-5 inline-flex gap-2.5 text-[clamp(24px,3.5vw,32px)] leading-none text-bronze"
        ...
        <p className="mb-3 font-mono text-[10px] uppercase tracking-[0.24em] text-bronze-deep">
          {siteConfig.foodHygiene.authority}
        </p>
        <h2 className="m-0 mb-3 font-serif text-[clamp(26px,3.6vw,38px)] font-medium leading-[1.08] tracking-[-0.005em] text-walnut">
          Five-Star{' '}
          <em className="font-normal italic text-bronze-deep">Food Hygiene</em> Rating
        </h2>
        ...
        <a
          ...
          className="inline-flex items-center gap-2 rounded-[2px] border border-bronze-deep px-6 py-3 font-serif text-[13px] font-semibold uppercase tracking-[0.16em] text-bronze-deep [font-variant:small-caps] transition-colors hover:bg-bronze-deep hover:text-cream"
        >
